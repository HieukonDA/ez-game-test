...
public class LeftUpperCutState : IState
{
    PlayerController _playerController;
    private float _timer;
    private float _duration;

    public LeftUpperCutState(PlayerController playerController)
    {
        _playerController = playerController;
    }
    public void Enter()
    {
        _playerController.LeftUppercut();
        _duration = GetAnimationDuration("LeftUpperCut");
        _timer = 0f;
