...
public class GetInputMenu : Panel
{
    ...
    public void Open(Callback callback, Type type, uint maxLength, string message = "what's your name?", string buttonPositive = "Confirm", string buttonNegative = "Cancel")
    {
        Open();
        this.type = type;
